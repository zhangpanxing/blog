...
function showMessage(a, c, e) { (e || "" === sessionStorage.getItem("waifu-text") || null === sessionStorage.getItem("waifu-text")) && (Array.isArray(a) && (a = a[Math.floor(Math.random() * a.length + 1) - 1]), live2d_settings.showF12Message && console.log("[Message]", a.replace(/<[^<>]+>/g, "")), e && sessionStorage.setItem("waifu-text", a), jQuery(".waifu-tips").stop(), jQuery(".waifu-tips").html(a).fadeTo(200, 1), void 0 === c && (c = 5E3), hideMessage(c))
}
function hideMessage(a) {
    jQuery(".waifu-tips").stop().css("opacity", 1);
    void 0 === a && (a = 5E3);
    window.setTimeout(function() {
        sessionStorage.removeItem("waifu-text")
    },
    a);
    jQuery(".waifu-tips").delay(a).fadeTo(200, 0)
}
function initModel(a, c) {
    console.log(" ");
    console.log("\u304f__,.\u30d8\u30fd.\u3000\u3000\u3000\u3000/\u3000,\u30fc\uff64 \u3009\n\u3000\u3000\u3000\u3000\u3000\uff3c ', !-\u2500\u2010-i\u3000/\u3000/\u00b4\n\u3000\u3000\u3000 \u3000 \uff0f\uff40\uff70'\u3000\u3000\u3000 L/\uff0f\uff40\u30fd\uff64\n\u3000\u3000 \u3000 /\u3000 \uff0f,\u3000 /|\u3000 ,\u3000 ,\u3000\u3000\u3000 ',\n\u3000\u3000\u3000\uff72 \u3000/ /-\u2010/\u3000\uff49\u3000L_ \uff8a \u30fd!\u3000 i\n\u3000\u3000\u3000 \uff9a \uff8d 7\uff72\uff40\uff84\u3000 \uff9a'\uff67-\uff84\uff64!\u30cf|\u3000 |\n\u3000\u3000\u3000\u3000 !,/7 '0'\u3000\u3000 \u00b40i\u30bd| \u3000 |\u3000\u3000\u3000\n\u3000\u3000\u3000\u3000 |.\u4ece\"\u3000\u3000_\u3000\u3000 ,,,, / |./ \u3000 |\n\u3000\u3000\u3000\u3000 \uff9a'| i\uff1e.\uff64,,__\u3000_,.\u30a4 / \u3000.i \u3000|\n\u3000\u3000\u3000\u3000\u3000 \uff9a'| | / k_\uff17_/\uff9a'\u30fd,\u3000\uff8a.\u3000|\n\u3000\u3000\u3000\u3000\u3000\u3000 | |/i \u3008|/\u3000 i\u3000,.\uff8d |\u3000i\u3000|\n\u3000\u3000\u3000\u3000\u3000\u3000.|/ /\u3000\uff49\uff1a \u3000 \uff8d!\u3000\u3000\uff3c\u3000|\n\u3000\u3000\u3000 \u3000 \u3000 k\u30fd>\uff64\uff8a \u3000 _,.\uff8d\uff64 \u3000 /\uff64!\n\u3000\u3000\u3000\u3000\u3000\u3000 !'\u3008//\uff40\uff34\u00b4', \uff3c \uff40'7'\uff70r'\n\u3000\u3000\u3000\u3000\u3000\u3000 \uff9a'\u30fdL__|___i,___,\u30f3\uff9a|\u30ce\n\u3000\u3000\u3000\u3000\u3000 \u3000\u3000\u3000\uff84-,/\u3000|___./\n\u3000\u3000\u3000\u3000\u3000 \u3000\u3000\u3000'\uff70'\u3000\u3000!_,.:\nLive2D \u770b\u677f\u5a18 v" + live2d_settings.l2dVersion + " / FGHRSH " + live2d_settings.l2dVerDate);
    console.log(" ");
    "function" != typeof jQuery.ajax && ("function" == typeof jQuery.ajax ? window.jQuery = jQuery: console.log("[Error] JQuery is not defined."));
    live2d_settings.waifuSize = live2d_settings.waifuSize.split("x");
    live2d_settings.waifuTipsSize = live2d_settings.waifuTipsSize.split("x");
    live2d_settings.waifuEdgeSide = live2d_settings.waifuEdgeSide.split(":");
    jQuery("#live2d").attr("width", live2d_settings.waifuSize[0]);
    jQuery("#live2d").attr("height", live2d_settings.waifuSize[1]);
    jQuery(".waifu-tips").width(live2d_settings.waifuTipsSize[0]);
    jQuery(".waifu-tips").height(live2d_settings.waifuTipsSize[1]);
    jQuery(".waifu-tips").css("top", live2d_settings.waifuToolTop);
    jQuery(".waifu-tips").css("font-size", live2d_settings.waifuFontSize);
    jQuery(".waifu-tool").css("font-size", live2d_settings.waifuToolFont);
    jQuery(".waifu-tool span").css("line-height", live2d_settings.waifuToolLine);
    "left" == live2d_settings.waifuEdgeSide[0] ? jQuery(".waifu").css("left", live2d_settings.waifuEdgeSide[1] + "px") : "right" == live2d_settings.waifuEdgeSide[0] && jQuery(".waifu").css("right", live2d_settings.waifuEdgeSide[1] + "px");
    window.waifuResize = function() {
        jQuery(window).width() <= Number(live2d_settings.waifuMinWidth.replace("px", "")) ? jQuery(".waifu").hide() : jQuery(".waifu").show()
    };
    "disable" != live2d_settings.waifuMinWidth && (waifuResize(), jQuery(window).resize(function() {
        waifuResize()
    }));
    try {
        "axis-x" == live2d_settings.waifuDraggable ? jQuery(".waifu").draggable({
            axis: "x",
            revert: live2d_settings.waifuDraggableRevert
        }) : "unlimited" == live2d_settings.waifuDraggable ? jQuery(".waifu").draggable({
            revert: live2d_settings.waifuDraggableRevert
        }) : jQuery(".waifu").css("transition", "all .3s ease-in-out")
    } catch(e) {
    ...
    jQuery(".waifu-tool .fui-home").click(function() {
        window.location = live2d_settings.homePageUrl
    });
    jQuery(".waifu-tool .fui-info-circle").click(function() {
        window.open(live2d_settings.aboutPageUrl)
    });
    "object" == (void 0 === a ? "undefined": _typeof(a)) ? loadTipsMessage(a) : jQuery.ajax({
        cache: !0,
    ...
    live2d_settings.showToolMenu || jQuery(".waifu-tool").hide();
    live2d_settings.canCloseLive2d || jQuery(".waifu-tool .fui-cross").hide();
    live2d_settings.canSwitchModel || jQuery(".waifu-tool .fui-eye").hide();
    live2d_settings.canSwitchTextures || jQuery(".waifu-tool .fui-user").hide();
    live2d_settings.canSwitchHitokoto || jQuery(".waifu-tool .fui-chat").hide();
    live2d_settings.canTakeScreenshot || jQuery(".waifu-tool .fui-photo").hide();
    live2d_settings.canTurnToHomePage || jQuery(".waifu-tool .fui-home").hide();
    live2d_settings.canTurnToAboutPage || jQuery(".waifu-tool .fui-info-circle").hide();
    void 0 === a && (a = "");
...
function loadTipsMessage(a) {
    ...
    function h() {
        "visible" == jQuery(document)[0].visibilityState && k()
    }
    function k() {
        switch (live2d_settings.hitokotoAPI) {
        case "lwl12.com":
            jQuery.getJSON("https://api.lwl12.com/hitokoto/v1?encode=realjson",
            function(a) {
                if (!empty(a.source)) {
            ...
            break;
        case "fghrsh.net":
            jQuery.getJSON("https://api.fghrsh.net/hitokoto/rand/?encode=jsc&uid=3335",
            function(a) {
                if (!empty(a.source)) {
        ...
        case "jinrishici.com":
            ...
            break;
        default:
            jQuery.getJSON("https://v1.hitokoto.cn",
            function(a) {
                if (!empty(a.from)) {
    ...
    window.waifu_tips = a;
    jQuery.each(a.mouseover,
    function(a, b) {
        jQuery(document).on("mouseover", b.selector,
        function() {
    ...
    jQuery.each(a.click,
    function(a, b) {
        jQuery(document).on("click", b.selector,
        function() {
            var a = getRandText(b.text);
            a = a.render({
                text: jQuery(this).text()
    ...
    live2d_settings.showCopyMessage && jQuery(document).on("copy",
    function() {
        showMessage(getRandText(a.waifu.copy_message), 5E3, !0)
    });
    jQuery(".waifu-tool .fui-photo").click(function() {
    ...
    jQuery(".waifu-tool .fui-cross").click(function() {
    ...
    window.showWelcomeMessage = function(a) {
        ...
        default)
            ...
            if ("" !== document.referrer) {
                ...
                window.location.hostname == c.hostname ? b = d.localhost[0] + document.title.split(d.localhost[2])[0] + d.localhost[1] : "baidu" == e ? b = d.baidu[0] + c.search.split("&wd=")[1].split("&")[0] + d.baidu[1] : "so" == e ? b = d.so[0] + c.search.split("&q=")[1].split("&")[0] + d.so[1] : "google" == e ? b = d.google[0] + document.title.split(d.google[2])[0] + d.google[1] : (jQuery.each(a.waifu.referrer_hostname,
                function(a, b) {
                    a == c.hostname && (c.hostname = getRandText(b))
                }), b = d.
            default[0] + c.hostname + d.
            default[1])
    ...
    var f = a.waifu;
    live2d_settings.showHitokoto && (window.getActed = !1, window.hitokotoTimer = 0, window.hitokotoInterval = !1, jQuery(document).mousemove(function(a) {
        getActed = !0
    }).keydown(function() {
        getActed = !0
    ...
    1E3));
    jQuery(".waifu-tool .fui-eye").click(function() {
        c()
    });
    jQuery(".waifu-tool .fui-user").click(function() {
        e()
    });
    jQuery(".waifu-tool .fui-chat").click(function() {
        k()
    })
}
...
String.prototype.render = function(a) {
    ...
    function(c, e, g, h) {
        ...
        h = a;
        c = 0;
        for (e = g.length; c < e; ++c) if (k = g[c], void 0 === (h = h[k]) || null === h) return "";
        return h
    })
};
var re = /x/;
